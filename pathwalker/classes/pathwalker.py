...
class PathWalker(object):
    ...
    def walk(self, fFilter=None, dFilter=None, abs=False):

        return self.__walk(self.dir, fFilter, dFilter, abs)

    def __walk(self, start, fFilter, dFilter, abs):
        ...
        for i in os.listdir(cDir):
            ...
            if os.path.isdir(i):
                ...
                if dFilter is not None:
                    ...
                    if dFilter(i):
                        dirs.append(self.__walk(i, fFilter, dFilter, abs) )
                else:
                    dirs.append(self.__walk(i, fFilter, dFilter, abs) )
